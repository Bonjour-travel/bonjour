<template>
   <div class="amap-wrapper">
        <p>Hello World</p>
       <el-amap vid="amap">
        <!-- <el-amap vid="amap" center="center = [lng, lat]" zoom="zoom"> -->
            <!-- <el-amap-marker vid="marker" position="marker.position" content-render="marker.contentRender"></el-amap-marker> -->
            <!-- <el-amap-marker position="position = [lng, lat]"></el-amap-marker> -->
            <!-- <el-amap-marker position="marker.position" :isHotspot="open"></el-amap-marker> -->
